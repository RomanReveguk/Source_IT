...
public class HW13_Task4_MultithreadingMax {

	public int multithreadinMaxDetermination(int[][] matrix) {
		int max = 0;
	...
	public Callable<Integer> getTask(int[] value) {
